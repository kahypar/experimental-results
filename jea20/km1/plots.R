...
order <- c("$r$KaHyPar", "hMETIS-R", "hMETIS-K", "PaToH-D", "PaToH-Q", "HYPE", "Mondriaan", "Zoltan-AlgD")
scaling <- 2.5
...
order <- c("HYPE", "PaToH-D", "PaToH-Q", "Mondriaan", "Zoltan-AlgD", "hMETIS-R", "hMETIS-K", "$k$KaHyPar", "$r$KaHyPar")
tikz("~/kahypar-jea/tikz_plots/km1_running_time_dac.tex", 
     width = 2.1666 * scaling, height = 1.666 * scaling, pointsize = 12)
type <- "DAC"
...
tikz("~/kahypar-jea/tikz_plots/km1_running_time_ispd.tex", 
     width = 2.1666 * scaling, height = 1.666 * scaling, pointsize = 12)
type <- "ISPD"
print(running_time_per_pin_box_plot(list(kahypar_k[kahypar_k$type == type,],
                                         kahypar_r[kahypar_r$type == type,], 
...
tikz("~/kahypar-jea/tikz_plots/km1_running_time_primal.tex", 
     width = 2.1666 * scaling, height = 1.666 * scaling, pointsize = 12)
type <- "Primal"
print(running_time_per_pin_box_plot(list(kahypar_k[kahypar_k$type == type,],
                                         kahypar_r[kahypar_r$type == type,], 
...
tikz("~/kahypar-jea/tikz_plots/km1_running_time_literal.tex", 
     width = 2.1666 * scaling, height = 1.666 * scaling, pointsize = 12)
type <- "Literal"
print(running_time_per_pin_box_plot(list(kahypar_k[kahypar_k$type == type,],
                                         kahypar_r[kahypar_r$type == type,], 
...
tikz("~/kahypar-jea/tikz_plots/km1_running_time_dual.tex", 
     width = 2.1666 * scaling, height = 1.666 * scaling, pointsize = 12)
type <- "Dual"
print(running_time_per_pin_box_plot(list(kahypar_k[kahypar_k$type == type,],
                                         kahypar_r[kahypar_r$type == type,], 
...
tikz("~/kahypar-jea/tikz_plots/km1_running_time_spm.tex", 
     width = 2.1666 * scaling, height = 1.666 * scaling, pointsize = 12)
type <- "SPM"
print(running_time_per_pin_box_plot(list(kahypar_k[kahypar_k$type == type,],
                                         kahypar_r[kahypar_r$type == type,], 
...
order <- c("HYPE", "PaToH-D", "PaToH-Q", "Mondriaan", "Zoltan-AlgD", "hMETIS-R", "hMETIS-K", "$k$KaHyPar", "$r$KaHyPar")
tikz("~/kahypar-jea/tikz_plots/km1_running_time_k_2.tex", 
     width = 2.1666 * scaling, height = 1.666 * scaling, pointsize = 12)
k <- 2
...
tikz("~/kahypar-jea/tikz_plots/km1_running_time_k_4.tex", 
     width = 2.1666 * scaling, height = 1.666 * scaling, pointsize = 12)
k <- 4
print(running_time_per_pin_box_plot(list(kahypar_k[kahypar_k$k == k,],
                                         kahypar_r[kahypar_r$k == k,], 
...
tikz("~/kahypar-jea/tikz_plots/km1_running_time_k_8.tex", 
     width = 2.1666 * scaling, height = 1.666 * scaling, pointsize = 12)
k <- 8
print(running_time_per_pin_box_plot(list(kahypar_k[kahypar_k$k == k,],
                                         kahypar_r[kahypar_r$k == k,], 
...
tikz("~/kahypar-jea/tikz_plots/km1_running_time_k_16.tex", 
     width = 2.1666 * scaling, height = 1.666 * scaling, pointsize = 12)
k <- 16
print(running_time_per_pin_box_plot(list(kahypar_k[kahypar_k$k == k,],
                                         kahypar_r[kahypar_r$k == k,], 
...
tikz("~/kahypar-jea/tikz_plots/km1_running_time_k_32.tex", 
     width = 2.1666 * scaling, height = 1.666 * scaling, pointsize = 12)
k <- 32
print(running_time_per_pin_box_plot(list(kahypar_k[kahypar_k$k == k,],
                                         kahypar_r[kahypar_r$k == k,], 
...
tikz("~/kahypar-jea/tikz_plots/km1_running_time_k_64.tex", 
     width = 2.1666 * scaling, height = 1.666 * scaling, pointsize = 12)
k <- 64
print(running_time_per_pin_box_plot(list(kahypar_k[kahypar_k$k == k,],
                                         kahypar_r[kahypar_r$k == k,], 
...
tikz("~/kahypar-jea/tikz_plots/km1_running_time_k_128.tex", 
     width = 2.1666 * scaling, height = 1.666 * scaling, pointsize = 12)
k <- 128
print(running_time_per_pin_box_plot(list(kahypar_k[kahypar_k$k == k,],
                                         kahypar_r[kahypar_r$k == k,], 
...
tikz("~/kahypar-jea/tikz_plots/km1_overall.tex", 
     width = 2.1666 * scaling, height = 1.666 * scaling, pointsize = 12)
...
tikz("~/kahypar-jea/tikz_plots/km1_overall_only_r_kahypar.tex", 
     width = 2.1666 * scaling, height = 1.666 * scaling, pointsize = 12)
...
tikz("~/kahypar-jea/tikz_plots/km1_dac.tex", 
     width = 2.1666 * scaling, height = 1.666 * scaling, pointsize = 12)
type <- "DAC"
...
tikz("~/kahypar-jea/tikz_plots/km1_ispd.tex", 
     width = 2.1666 * scaling, height = 1.666 * scaling, pointsize = 12)
type <- "ISPD"
print(performace_plot(list(kahypar_k[kahypar_k$type == type,],
                           kahypar_r[kahypar_r$type == type,], 
...
tikz("~/kahypar-jea/tikz_plots/km1_primal.tex", 
     width = 2.1666 * scaling, height = 1.666 * scaling, pointsize = 12)
type <- "Primal"
print(performace_plot(list(kahypar_k[kahypar_k$type == type,],
                           kahypar_r[kahypar_r$type == type,], 
...
tikz("~/kahypar-jea/tikz_plots/km1_literal.tex", 
     width = 2.1666 * scaling, height = 1.666 * scaling, pointsize = 12)
type <- "Literal"
print(performace_plot(list(kahypar_k[kahypar_k$type == type,],
                           kahypar_r[kahypar_r$type == type,], 
...
tikz("~/kahypar-jea/tikz_plots/km1_dual.tex", 
     width = 2.1666 * scaling, height = 1.666 * scaling, pointsize = 12)
type <- "Dual"
print(performace_plot(list(kahypar_k[kahypar_k$type == type,],
                           kahypar_r[kahypar_r$type == type,], 
...
tikz("~/kahypar-jea/tikz_plots/km1_spm.tex", 
     width = 2.1666 * scaling, height = 1.666 * scaling, pointsize = 12)
type <- "SPM"
print(performace_plot(list(kahypar_k[kahypar_k$type == type,],
                           kahypar_r[kahypar_r$type == type,], 
...
tikz("~/kahypar-jea/tikz_plots/km1_instance_types_legend.tex", 
...
tikz("~/kahypar-jea/tikz_plots/km1_k_2.tex", 
     width = 2.1666 * scaling, height = 1.666 * scaling, pointsize = 12)
k <- 2
...
tikz("~/kahypar-jea/tikz_plots/km1_k_4.tex", 
     width = 2.1666 * scaling, height = 1.666 * scaling, pointsize = 12)
k <- 4
print(performace_plot(list(kahypar_k[kahypar_k$k == k,],
                           kahypar_r[kahypar_r$k == k,], 
...
tikz("~/kahypar-jea/tikz_plots/km1_k_8.tex", 
     width = 2.1666 * scaling, height = 1.666 * scaling, pointsize = 12)
k <- 8
print(performace_plot(list(kahypar_k[kahypar_k$k == k,],
                           kahypar_r[kahypar_r$k == k,], 
...
tikz("~/kahypar-jea/tikz_plots/km1_k_16.tex", 
     width = 2.1666 * scaling, height = 1.666 * scaling, pointsize = 12)
k <- 16
print(performace_plot(list(kahypar_k[kahypar_k$k == k,],
                           kahypar_r[kahypar_r$k == k,], 
...
tikz("~/kahypar-jea/tikz_plots/km1_k_32.tex", 
     width = 2.1666 * scaling, height = 1.666 * scaling, pointsize = 12)
k <- 32
print(performace_plot(list(kahypar_k[kahypar_k$k == k,],
                           kahypar_r[kahypar_r$k == k,], 
...
tikz("~/kahypar-jea/tikz_plots/km1_k_64.tex", 
     width = 2.1666 * scaling, height = 1.666 * scaling, pointsize = 12)
k <- 64
print(performace_plot(list(kahypar_k[kahypar_k$k == k,],
                           kahypar_r[kahypar_r$k == k,], 
...
tikz("~/kahypar-jea/tikz_plots/km1_k_128.tex", 
     width = 2.1666 * scaling, height = 1.666 * scaling, pointsize = 12)
k <- 128
print(performace_plot(list(kahypar_k[kahypar_k$k == k,],
                           kahypar_r[kahypar_r$k == k,], 
...
tikz("~/kahypar-jea/tikz_plots/km1_k_legend.tex", 
     width = 2.1666 * scaling, height = 1.666 * scaling, pointsize = 12)
...
tikz("~/kahypar-jea/tikz_plots/km1_kahypar_k_vs_kahypar_r.tex", 
     width = 2.1666 * scaling, height = 1.666 * scaling, pointsize = 12)
print(performace_plot(list(kahypar_k,
                           kahypar_r), 
                      objective = "avg_km1", 
...
tikz("~/kahypar-jea/tikz_plots/km1_kahypar_k_vs_hmetis_r.tex", 
     width = 2.1666 * scaling, height = 1.666 * scaling, pointsize = 12)
print(performace_plot(list(kahypar_k,
                           hmetis_r), 
                      objective = "avg_km1", 
...
tikz("~/kahypar-jea/tikz_plots/km1_kahypar_k_vs_hmetis_k.tex", 
     width = 2.1666 * scaling, height = 1.666 * scaling, pointsize = 12)
print(performace_plot(list(kahypar_k,
                           hmetis_k), 
                      objective = "avg_km1", 
...
tikz("~/kahypar-jea/tikz_plots/km1_kahypar_k_vs_patoh_d.tex", 
     width = 2.1666 * scaling, height = 1.666 * scaling, pointsize = 12)
print(performace_plot(list(kahypar_k,
                           patoh_d), 
                      objective = "avg_km1", 
...
tikz("~/kahypar-jea/tikz_plots/km1_kahypar_k_vs_patoh_q.tex", 
     width = 2.1666 * scaling, height = 1.666 * scaling, pointsize = 12)
print(performace_plot(list(kahypar_k,
                           patoh_q), 
                      objective = "avg_km1", 
...
tikz("~/kahypar-jea/tikz_plots/km1_kahypar_k_vs_zoltan_alg_d.tex", 
     width = 2.1666 * scaling, height = 1.666 * scaling, pointsize = 12)
print(performace_plot(list(kahypar_k,
                           zoltan_alg_d), 
                      objective = "avg_km1", 
...
tikz("~/kahypar-jea/tikz_plots/km1_kahypar_k_vs_mondriaan.tex", 
     width = 2.1666 * scaling, height = 1.666 * scaling, pointsize = 12)
print(performace_plot(list(kahypar_k,
                           mondriaan), 
                      objective = "avg_km1", 
...
tikz("~/kahypar-jea/tikz_plots/km1_kahypar_k_vs_hype.tex", 
     width = 2.1666 * scaling, height = 1.666 * scaling, pointsize = 12)
print(performace_plot(list(kahypar_k,
                           hype), 
                      objective = "avg_km1", 
...
tikz("~/kahypar-jea/tikz_plots/km1_kahypar_r_vs_hmetis_r.tex", 
     width = 2.1666 * scaling, height = 1.666 * scaling, pointsize = 12)
print(performace_plot(list(kahypar_r,
                           hmetis_r), 
                      objective = "avg_km1", 
...
tikz("~/kahypar-jea/tikz_plots/km1_kahypar_r_vs_hmetis_k.tex", 
     width = 2.1666 * scaling, height = 1.666 * scaling, pointsize = 12)
print(performace_plot(list(kahypar_r,
                           hmetis_k), 
                      objective = "avg_km1", 
...
tikz("~/kahypar-jea/tikz_plots/km1_kahypar_r_vs_patoh_d.tex", 
     width = 2.1666 * scaling, height = 1.666 * scaling, pointsize = 12)
print(performace_plot(list(kahypar_r,
                           patoh_d), 
                      objective = "avg_km1", 
...
tikz("~/kahypar-jea/tikz_plots/km1_kahypar_r_vs_patoh_q.tex", 
     width = 2.1666 * scaling, height = 1.666 * scaling, pointsize = 12)
print(performace_plot(list(kahypar_r,
                           patoh_q), 
                      objective = "avg_km1", 
...
tikz("~/kahypar-jea/tikz_plots/km1_kahypar_r_vs_zoltan_alg_d.tex", 
     width = 2.1666 * scaling, height = 1.666 * scaling, pointsize = 12)
print(performace_plot(list(kahypar_r,
                           zoltan_alg_d), 
                      objective = "avg_km1", 
...
tikz("~/kahypar-jea/tikz_plots/km1_kahypar_r_vs_mondriaan.tex", 
     width = 2.1666 * scaling, height = 1.666 * scaling, pointsize = 12)
print(performace_plot(list(kahypar_r,
                           mondriaan), 
                      objective = "avg_km1", 
...
tikz("~/kahypar-jea/tikz_plots/km1_kahypar_r_vs_hype.tex", 
     width = 2.1666 * scaling, height = 1.666 * scaling, pointsize = 12)
print(performace_plot(list(kahypar_r,
                           hype), 
                      objective = "avg_km1", 

...
kahypar_r_1 <- read.csv("km1_rKaHyPar.csv", header = TRUE)
kahypar_k_1 <- read.csv("km1_kKaHyPar.csv", header = TRUE)
kahypar_r_1 <- kahypar_r_1[kahypar_r_1$seed == 1,]
kahypar_k_1 <- kahypar_k_1[kahypar_k_1$seed == 1,]
kahypar_r_1 <- aggreg_data(kahypar_r_1, timelimit = 30000, epsilon = 0.03)
kahypar_k_1 <- aggreg_data(kahypar_k_1, timelimit = 30000, epsilon = 0.03)
kahypar_r_1$algorithm <- "$r$KaHyPar"
